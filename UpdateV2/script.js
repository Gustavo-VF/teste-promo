...
function verificar() {
    ...
    const yy = chave.substr(20, 2);
    const mes = chave.substr(4, 2);
    const ano = chave.substr(2, 2);
    const cnpj = chave.substring(6, 20);
    const sat = chave.substr(22, 3);
    const numero = chave.substr(25, 9);
    ...
    if (yy === "55") {
        url = universalLink || "chave invalida";
        url2 = universalLink2 || "chave invalida";
        document.getElementById("resultado").style.display = "block";
        document.getElementById("link2").style.display = "block";
        document.getElementById("botoes2").style.display = "block";
        link21.href = url;
        link22.href = url2;
        link21.textContent = url;
        link22.textContent = url2;
    } else if (yy === "59") {
        url = satLinks[uf] || "chave invalida";
        document.getElementById("resultado").style.display = "block";
        document.getElementById("link1").style.display = "block";
        document.getElementById("botoes1").style.display = "block";
        link.href = url ;
        link.textContent = url ;
    } else if (yy === "65") {
        url = nfceLinks[uf] || "chave invalida";
        document.getElementById("resultado").style.display = "block";
        document.getElementById("link1").style.display = "block";
        document.getElementById("botoes1").style.display = "block";
    ...
    if (!estadoNomes[uf] || !mesNome[mes]) {
        erroInput.textContent = ("Chave invalida. Verifique se os digitos estao corretos e tente novamente.");
        document.getElementById("resultado").style.display = "none";
        document.getElementById("erroInput").style.display = "block";
        return;
    }

    displayestado.textContent = estadoNomes[uf] || "estado inválido";
    displaymes.textContent = mes + " - " + mesNome[mes] || "Mês inválido";
